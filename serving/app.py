...
async def predict(request: PredictionRequest):
    try:
        ...
        feature_vector = store.get_online_features(
            features=["user_click_features:click_count"], entity_rows=[{"user_id": request.user_id}]
        ).to_dict()

        print("FEATURE VECTOR:", feature_vector)

        current_click_count = feature_vector.get("click_count", [None])[0]
        ...
        return {
            ...
            "features_retrieved": {"click_count": current_click_count},
